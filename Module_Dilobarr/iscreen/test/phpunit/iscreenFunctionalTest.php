...
//        )
	...
	{
		$this->url('/custom/iscreen/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('iscreen/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	public function testAboutPage()
	{
		...
		$this->authenticate();
		return $this->assertContains('iscreen/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('iscreenwidget1', $this->source(), "Box enabled");
	}

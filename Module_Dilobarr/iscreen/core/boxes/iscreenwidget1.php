...
/**
 * \file    modulebuilder/template/core/boxes/iscreenwidget1.php
 * \ingroup iscreen
 * \brief   Widget provided by iscreen
 *
 ...
 */
class iscreenwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "iscreenbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "iscreen@iscreen";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->iscreen->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/iscreen/class/iscreen.class.php";

		// Populate the head at runtime
		$text = $langs->trans("iscreenBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_iscreen@iscreen',

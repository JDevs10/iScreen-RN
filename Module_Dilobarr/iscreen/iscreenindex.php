...
/**
 *	\file       htdocs/iscreen/template/iscreenindex.php
 *	\ingroup    iscreen
 *	\brief      Home page of iscreen top menu
 */
...
$langs->loadLangs(array("iscreen@iscreen"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->iscreen->read) accessforbidden();
...
llxHeader("",$langs->trans("iscreenArea"));

print load_fiche_titre($langs->trans("iscreenArea"),'','iscreen.png@iscreen');
...
// Draft MyObject
if (! empty($conf->iscreen->enabled) && $user->rights->iscreen->read)
{
	$langs->load("orders");
